...
2. Download protobuf >= 3.0.0 from https://github.com/google/protobuf/ (download ZIP and unZIP at desired location, or clone the repo). The protocol buffer is used for communication between the CuraEngine and the GUI.
