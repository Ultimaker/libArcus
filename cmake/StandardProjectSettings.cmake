...
function(set_rpath project_name)
    if(ARGV1)
        set(_relative_path ${ARGV1})
    else()
        set(_relative_path "../lib")
    endif()
    ...
    if (APPLE)
        ...
        set_target_properties(${project_name} PROPERTIES INSTALL_RPATH "@executable_path/${_relative_path}")
        message(STATUS "Setting relative install RPATH for target ${project_name} to @executable_path/${_relative_path}")
    else()
        set_target_properties(${project_name} PROPERTIES INSTALL_RPATH "$ORIGIN/${_relative_path}")
        message(STATUS "Setting relative install RPATH for target ${project_name} to $ORIGIN/${_relative_path}")
    endif()
endfunction()
